...
public class TestEnregistrementHandler {
	...
	final static String xmlReponse = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\" standalone=\"yes\" ?>"
			...
			+ "					<desc>Faits marquants de recherche, exemples d'activit�s.</desc>"
			+ "				</link>" + "				<link rank=\"2\" score=\"0\">"
			+ "					<title>INRA - Premier s�quen�age d'une bact�rie du yaourt : Streptococcus ...</title>"
			...
			+ "					<desc>Aide aux �tudiants pour la recherche d'information scientifique. Cours, exercices et outils (moteurs, annuaires etc.) Les principaux outils de recherche, ...</desc>"
			+ "				</link>" + "				<link rank=\"4\" score=\"0\">"
			+ "					<title>D�veloppement de l'�levage en Afrique subsaharienne - Un exemple ...</title>"
			...
			+ "					<desc>Un exemple de recherche r�gionale : le CIRDES. En 1991, le Centre de Recherches sur les Trypanosomoses Animales (CRTA) de Bobo-Dioulasso (Burkina), ...</desc>"
			+ "				</link>" + "				<link rank=\"5\" score=\"0\">"
			+ "					<title>exemple de recherche : mod�liser le renouvellement des conduites d'eau</title>"
			+ "					<url>http://www.cemagref.fr/INformations/Ex-rechr/eau-dechets/bremond/Bremond-exemple.htm</url>"
			+ "					<desc>Exemples de recherche Mod�liser le renouvellement des conduites d'eau ... Cet exemple r�pond � un enjeu : technologies et services de l'eau , des effluents ...</desc>"
			...
			+ "					<desc>Evaluation et cartographie du risque d'incendie de for�t sur le massif par Cemagref.</desc>"
			...
			+ "					<desc>CHOISIR des outils de recherche > Exemple de recherche sur Altavista > Accueil ... Altavista n'est pas forc�ment le moteur de recherche le plus exhaustif. ...</desc>"
			+ "				</link>" + "				<link rank=\"8\" score=\"0\">"
			+ "					<title>SAPRISTI ! SAPRISTI ! PRESENTATION TROUVER des documents ...</title>"
			+ "					<url>http://docinsa.insa-lyon.fr/sapristi/index.php?rub=0602</url>"
			+ "					<desc>APPLIQUER quelques conseils > Exemple de recherche sur Altavista > Accueil ... Altavista n'est pas forc�ment le moteur de recherche le plus exhaustif. ...</desc>"
			+ "				</link>" + "				<link rank=\"9\" score= \"0\">"
			+ "					<title>NotreTemps.com - M�thode : un exemple de recherche</title>"
			+ "					<url>http://www.notretemps.com/article/index.jsp?docId=1292205&amp;rubId=14095</url>"
			+ "					<desc>M�thode : un exemple de recherche Vous venez de dresser l'inventaire de toutes les sources d'information disponibles chez vous ou dans votre entourage et ...</desc>"
			...
			+ "					<desc>Un exemple de recherche en droit :. le CRJO. Depuis sa cr�ation, le CRJO a toujours travaill� sur la justice. m�me si, avant 1992, elle s'int�ressait ...</desc>"
			+ "				</link>" + "				<link rank=\"12\" score=\"0\">"
			+ "					<title>DSI. Le palmar�s des villes, places d'affaires, best cities ou ...</title>"
			+ "					<url>http://www.dsi-info.ca/palmares-des-villes-best-cities.html</url>"
			+ "					<desc>La strat�gie de recherche utilis�e ici est un exemple. D'autres outils de recherche peuvent �tre utilis�s comme le logiciel de recherche Copernic ou un ...</desc>"
			...
			+ "					<desc>Exemple de recherche. Holocene lake succession and palaeo-optics of a subarctic lake, northern Qu�bec (Canada). Saulnier-Talbot, �., Pienitz, R., Vincent, ...</desc>"
			...
			+ "					<desc>Exemples de recherche; Th�saurus; Affichage des titres ... Les exemples suivants indiquent les options principales de la recherche dans \"Tous domaines\". ...</desc>"
			+ "				</link>" + "				<link rank=\"15\" score=\"0\">"
			+ "					<title>R�f�rence rapide pour effectuer une recherche dans l'Encyclop�die ...</title>"
			+ "					<url>http://www.ilocis.org/fr/help.html</url>"
			+ "					<desc>Recherche au moyen de, Exemple(s), Trouver tous les enregistrements ... Consultez Recherche par zone particuli�re pour obtenir des exemples de la mani�re ...</desc>"
			+ "				</link>" + "				<link rank=\"16\" score=\"0\">"
			+ "					<title>Un exemple de recherche</title>"
			+ "					<url>http://www.bpi.fr/clips/wmv4.html</url>"
			+ "					<desc>4. Un exemple de recherche. Acc�s au clip en \"streaming\", ( liaisons haut d�bit, format Windows Media Player)</desc>"
			+ "				</link>" + "				<link rank=\"17\" score=\"0\">"
			+ "					<title>Exemple de recherche des k-itemsets fr�quents</title>"
			+ "					<url>http://www.lifl.fr/west/publi/Marq00parm/parm-apr00005.html</url>"
			+ "					<desc>2.4 Exemple de recherche des k-itemsets fr�quents. Soient. I = {A, B, C, D, E, F}; T = {AB, ABCD, ABD, ABDF, ACDE, BCDF}; smin = 1/2 ...</desc>"
			...
			+ "					<desc>existence des diff�rents sucres, qu'est-ce que \"le sucre\", exemples de formules et de ... Le travail de recherche d'informations est r�parti sur les deux ...</desc>"
	...
	public static void main(String args[]) {
		...
		try {
			...
			GestionMessage.message(2, "La_classe",
					"Erreur de configuration du parseur, Lors de l'appel � SAXParser.newSAXParser() : " + pce);
		} catch (SAXException se) {
			GestionMessage.message(2, "La_classe", "Erreur de parsing, Lors de l'appel � parse() : " + se);
