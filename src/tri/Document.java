...
public class Document extends Lien {
	 ...
	 * Initialisation de:
	 * 		- l'identifiant a -1,
	 * 		- des mots cles a NULL,
	 * 		- de l'url a NULL,
	 * 		- du tire a NULL,
	 * 		- de la description a NULL,
	 *		- du rang a 0. 
	 */	
	public Document() {
		id = -1;
	...
	/**
	 * Constructeur permettant d'initialiser un document a
	 * parir de: son identifiant, ses mots cles, son url,
	 * son titre, sa description et son rang. 
	 * 
	 * @param id		Un entier representant un identifiant de document.
	 * @param motsCles	Un vecteur representant un ensemble de mots cles
	 * 					correspondant a ce document.
	 * @param url		Un objet representant une url.
	 * @param titre		Un objet representant un titre.
	 * @param desc		Un objet representant une description.
	 * @param rang		Un entier representant un rang.
	 */	
	 ...
	 * 
	 * @return		int : Un entier representant l'identifiant du
	 *              document courant.
	 */
	public int getIdDoc() {
		return id;
