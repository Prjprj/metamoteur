...
public class TestTri {
	...
	public static void main(String args[]) {
		...
		/*
		Tri.initEnrLocal(enrAL);
		Vector ensEnrTries = Tri.ensEnrTriesLiensSimilairesAA(ensEnrAA);
		Enregistrement enrTrie1 = (Enregistrement) ensEnrTries.elementAt(0);
		Vector liensTries1 = enrTrie1.getLiens();
		Enregistrement enrTrie2 = (Enregistrement) ensEnrTries.elementAt(1);
		Vector liensTries2 = enrTrie2.getLiens();
		System.out.println("ID    : " + enrTrie1.getId() + "          " + enrTrie2.getId());
		System.out.println("Mots  : " + enrTrie1.getKeywords() + "          " + enrTrie2.getKeywords());
		for (int i=0; i<liensTries1.size(); i++) {
			System.out.print("Lien " + i + " :  ");
			System.out.println(((Lien)liensTries1.elementAt(i)).getUrl()); 
			System.out.print("Enr1   Rang :" + ((Lien) liensTries1.elementAt(i)).getRang());
			System.out.println("     Score :" + ((Lien) liensTries1.elementAt(i)).getScore());
			System.out.print("Enr2   Rang :" + ((Lien) liensTries2.elementAt(i)).getRang());
			System.out.println("    Score :" + ((Lien) liensTries2.elementAt(i)).getScore());
		...
		Vector moyenneRangs = Tri.moyenneRangsLiensAA(ensEnrTries);
		System.out.println("\nMoyenne du rang de chaque lien pour les autres agents : ");
		for (int i=0; i<moyenneRangs.size(); i++) {
			System.out.println("   Moyenne lien " + i + " : " + moyenneRangs.elementAt(i));
		}
		...
		System.out.println("\nMoyenne generale de tous les agents en tenant \n" +
				...
				"ponderation pour les autres agents :");
		for (int i=0; i<moyenneRangs.size(); i++) {
			System.out.println("   Moyenne lien " + i + " : " + moyenneTotale.elementAt(i));
		}		
