...
public class Permutations {
     ...
     *
     * @param motsCles String : Une chaine de caracteres(ceux entres par l'utilisateur).
     ...
     *
     * @param urlMR      String : Une chaine de caractere representant une url (celle
     ...
     *
     * @param descMR     String : Une chaine de caractere representant une description
     ...
     * @param nbRangs    int : Un entier representant le nombre d'entier (de rang) sommes.
    ...
    /**
     * Retourne le premier entier disponible, c'est-a-dire le premier entier
     ...
     *
     * @param rangPresent  int : Un entier representant le rang immediatement inferieur a
     *                     celui a inserer.
     * @param nbDisponible int : Un entier qui n'est pas present dans le vecteur d'entiers
     *                     passe en parametre.
     ...
     *
     * @param rangPresent  int : Un entier representant le rang immediatement superieur a
     *                     celui a inserer.
     * @param nbDisponible int : Un entier qui n'est pas present dans le vecteur d'entiers
     *                     passe en parametre.
     * @param v            Vector : Un vecteur d'entiers.
     ...
     *
     * @param sommeRangs int : Un entier representant la somme de certains rangs.
     * @param nbRangs    int : Un entier representant le nombre d'entiers, correspondant au
     ...
     * selon les enregistrements contenus dans la base de donnees de l'agent local).
     *
     * @param rangMin int : Un entier representant le rang minimum trouve parmi les
     *                documents retenus.
     ...
     * vecteurs a retourner, alors nous incrementons ou decrementons d'une unit� la
     ...
     *
     * @param enrMR         Enregistrement L'enregistrement retourne par le(s) moteur(s) de
     *                      recherche.
     * @param casSrcRetenus Vector : Le vecteur de Cas Sources (enregistrements retenus par la
     ...
     *
     * @param id          int : Un entier representant l'identifiant d'un document.
     ...
     *
     * @param rang1_MR      int : Un entier representant le rang du document 1 dans les
     *                      reponses envoyees par le(s) moteur(s) de recherche.
     * @param rang2_MR      int : Un entier representant le rang du document 2 dans les
     *                      reponses envoyees par le(s) moteur(s) de recherche.
     * @param rang1_Associe int : Un entier representant le rang du document 1 associe via les
     *                      documents de la base de donnees.
     * @param rang2_Associe int : Un entier representant le rang du document 2 associe via les
     *                      documents de la base de donnees.
     ...
     * positive.
     *
     * @param vote double : Un reel representant la valeur du vote retournee par la
     *             methode "vote".
     ...
     *
     * @param typeValeur    int : Un entier representant le type de valeur retournee par la
     *                      methode "vote".
     * @param d1            Document : Un document a permute avec un autre.
     * @param d2            Un document.
     * @param rangsAssocies Vecror : Un vecteur d'entiers representant, pour chaque indice i,
     ...
     * autre.
     *
     * @param d_i           Document : Un document parmi ceux retourne par le(s) moteur(s) de
     *                      recherche.
     * @param d_k           Document : Un autre Document.
     * @param rangsAssocies Un vecteur d'entiers representant les rangs associes a chaque lien
     *                      retourne par le(s) moteur(s) de recherche.
     * @param vecteurDocs   Vector : Un vecteur de Documents (contenant tous les liens
     *                      retournes par le(s) moteur(s) de recherche).
     ...
     *
     * @param enrMR         Enregistrement : Un Enregistrement representant celui retourne par
     *                      le(s) moteur(s) de recherche.
     * @param rangsAssocies Vector : Un vecteur d'entiers representant les rangs associes a
     ...
     * @param enrMR       Enregistrement : Un Enregistrement representant celui retourne par
     *                    le(s) moteur(s) de recherche.
     * @param vecteurDocs Vector : Un vecteur de Documents (contenant les liens retournes
