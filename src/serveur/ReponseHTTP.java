...
public class ReponseHTTP {
	 ...
	 * 
	 * @param fichierPointe fichier sur lequel va pointer la requete
	 * @param URL url sur laquelle doit etre operee la redirection (ne fonctionne pas)
	 */
	...
	public void envoieFichierTexte(OutputStream sortie,int code,Fichier fichier){
		...
		try{
        	...
        	//affichage d'un message en cas d'erreur
			GestionMessage.message(1,"ReponseHTTP","Erreur d'entree sorties dans l'envoi du fichier texte "+fichier+" : "+e);
		}
	}
	/**
	...
	public void redirection(PrintWriter sortie,String url){
		...
		corps+="<HTML>"+Constantes.retourChariot+"<HEAD>"+Constantes.retourChariot+"<META http-EQUIV=\"Refresh\" CONTENT=\"0; url="+url+"\">"+Constantes.retourChariot;
		corps+="</HEAD>"+Constantes.retourChariot+"<BODY>"+Constantes.retourChariot+"<P>"+Constantes.retourChariot+"Redirection vers <a href=\""+url+"\">"+url+"</a>"+Constantes.retourChariot;
		corps+="</P>"+Constantes.retourChariot+"</BODY>"+Constantes.retourChariot+"</HTML>"+Constantes.retourChariot+Constantes.retourChariot+Constantes.retourChariot;
	...
	public void envoieImage(OutputStream sortie,Fichier fichier){
		...
		try{
			...
			//affichage d'un message en cas d'erreur
			GestionMessage.message(1,"ReponseHTTP","Erreur d'entree sorties dans l'envoi de l'image "+fichier+" : "+e);
		}
	}
	/**
	 * Methode renvoyant une chaine permettant l'envoi d'une page d'erreur 404 au client
	 * 
	...
	/**
	 * Methode permettant de renvoyer le debut de la page a renvoyer au client, toujours la meme donc inutile de la mettre dans toXhtml
	 * 
	...
	public static String debutReponseHTML(){
		...
		chaine+="<a href=\"index.html\"><img src=\"images/logo.png\" alt=\"Network search logo\" /></a>"+Constantes.retourChariot;
		chaine+="</div>"+Constantes.retourChariot;
		chaine+="</div>"+Constantes.retourChariot;
		...
		chaine+="<li>"+Constantes.retourChariot;
		chaine+="<a href=\"aide.html\" accesskey=\"a\"><span class=\"underline\">A</span>ide</a>"+Constantes.retourChariot;
		chaine+="</li>"+Constantes.retourChariot;
		chaine+="<li>"+Constantes.retourChariot;
		chaine+="<a href=\"apropos.html\" accesskey=\"p\">A <span class=\"underline\">P</span>ropos</a>"+Constantes.retourChariot;
		chaine+="</li>"+Constantes.retourChariot;
		chaine+="</ul>"+Constantes.retourChariot;
		chaine+="</div>"+Constantes.retourChariot;
		...
		chaine+="<input name=\"recherche\" id=\"recherche\" value=\"\" tabindex=\"1\" type=\"text\" />"+Constantes.retourChariot;
		...
		chaine+="<p><input id=\"moteurs\" name=\"moteur1\" value=\"0\" type=\"checkbox\" onclick=\"if (this.checked) { clicTous(this.form,true) } else { clicTous(this.form,false) };\" />"+Constantes.retourChariot;
	...
	/**
	 * Methode permettant de prevenir le client si le moteur de recherche n'a rien repondu
	 * 
	...
	public static String pasDeReponse(String motsCle){
		...
		chaine+=" Résultats de la recherche : "+motsCle+Constantes.retourChariot;
		chaine+="</h1>"+Constantes.retourChariot;
		chaine+="<div class=\"blockDistinct\">"+Constantes.retourChariot;
		chaine+="<p>"+Constantes.retourChariot;
		chaine+="Désolé, mais le moteur de recherche ne nous a pas fourni de réponse"+Constantes.retourChariot;
		chaine+="</p>"+Constantes.retourChariot;
		chaine+="</div>"+Constantes.retourChariot;
		chaine+="</div>"+Constantes.retourChariot;
		...
		chaine+="</li>"+Constantes.retourChariot;
		chaine+="<li><a href=\"stoppeAgent.html\">Arrêt du serveur</a></li>";
		chaine+="</ul>"+Constantes.retourChariot;
		chaine+="<p>"+Constantes.retourChariot;
		chaine+="<a href=\"licence.html\">CopyLeft</a> &copy; Méta-moteur Staff 2006"+Constantes.retourChariot;
		chaine+="</p>"+Constantes.retourChariot;
		chaine+="</div>"+Constantes.retourChariot;
		chaine+="</div>"+Constantes.retourChariot;
		chaine+="</body>"+Constantes.retourChariot;
