		...
		try {
			...
			GestionMessage
					.message(
							2,
							"La_classe",
							"Erreur de configuration du parseur, Lors de l'appel à SAXParser.newSAXParser() : "
									+ pce);
			...
			GestionMessage.message(2, "La_classe",
					"Erreur d'entrée/sortie, Lors de l'appel à parse() : "
							+ ioe);
		}
