...
public class TestEnregistrement {
	...
	public static void main(String args[]) {
		/*
		Vector v = Enregistrement.recuperationEnregistrements();
		Enregistrement enr = (Enregistrement) v.elementAt(1);
		Enregistrement enr = Enregistrement.recuperationEnregistrement(2);
		System.out.println(enr.getId());
		System.out.println(enr.getKeywords());
		...
		int max = Enregistrement.entierMaximum(v); 
		...
		System.out.println("Resultat :" +  v.size());
		System.out.println("Resultat :" +  res.size());
		...
		*/
		...
		Enregistrement enr = Enregistrement.recuperationEnregistrement(40);
		Vector resLiens = enr.getLiens();
		for (int i=0; i<resLiens.size(); i++) {
			System.out.println("Lien " + i + " :    " + ((Lien)resLiens.elementAt(i)).getUrl());
			System.out.print("    Rang :" + ((Lien) resLiens.elementAt(i)).getRang());
			System.out.println("    Score :" + ((Lien) resLiens.elementAt(i)).getScore());
		}
		*/
